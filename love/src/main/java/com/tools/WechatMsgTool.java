...
//    TimerTool timerTool;
    ...
    private Weather weather1; //1
    private Weather weather2; //1
    ...
    public static void main(String[] args) throws ParseException, InterruptedException {
        ...
        wm.SendWeChatMsg(wm.getToken(), "1");
    }
    ...
    public String getToken() {
        ...
        weather1 = weatherTool.getWeather("1");
        weather2 = weatherTool.getWeather("1");
        return token;
    }
...
//                System.out.println("进入定时器,当前时间：" + simpleDateFormat.format(System.currentTimeMillis()));
                ...
                if(second==0 && minutes%10==0){
                    log.info("进入定时器,当前时间：" + simpleDateFormat.format(System.currentTimeMillis()));
                }
    ...
    public String daYiMa() throws InterruptedException, ParseException {
        return (28 - (System.currentTimeMillis() - date1.getTime()) / (1000 * 60 * 60 * 24)) % 28 + "";
    }
